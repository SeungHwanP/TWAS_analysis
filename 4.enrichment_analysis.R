...
### COVID-T2D
genes <- fread("/storage0/lab/psh/TWAS/result_pleio/result_250220/3-2.result_geneinfo_COVID_Sev(HGI)_T2D.csv")
...
fwrite(ress,"/storage0/lab/psh/TWAS/result_pleio/result_250711/4.enrichr_COVID_T2D_cut.txt",row.names=F,quote=F,sep="\t",col.names=T)
fwrite(ress,"/storage0/lab/psh/TWAS/result_pleio/result_250711/4.enrichr_COVID_T2D_cut.csv",row.names=F,quote=F,sep=",",col.names=T)
